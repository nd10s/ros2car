...
#include "ds4_driver_msgs/msg/detail/trackpad__rosidl_typesupport_fastrtps_c.h"
...
using _Trackpad__ros_msg_type = ds4_driver_msgs__msg__Trackpad;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Trackpad__ros_msg_type * ros_message = static_cast<const _Trackpad__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Trackpad__ros_msg_type * ros_message = static_cast<_Trackpad__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _Trackpad__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ds4_driver_msgs__msg__Trackpad(
...
static size_t _Trackpad__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ds4_driver_msgs__msg__Trackpad(
...
static message_type_support_callbacks_t __callbacks_Trackpad = {
  "ds4_driver_msgs::msg",
  "Trackpad",
...
static rosidl_message_type_support_t _Trackpad__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Trackpad,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds4_driver_msgs, msg, Trackpad)() {
  return &_Trackpad__type_support;
}
